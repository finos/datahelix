...
class InMapIndexRelationTest {
    ...
    static void before() {
        ...
        testInstance = new InMapIndexRelation(f1, f2, new UniformList<>(values));
    }
    ...
    void reduceToRelatedFieldSpec_whenAllValid_returnCompleteWhiteList() {
        ...
        FieldSpec expected = FieldSpecFactory.fromList(new UniformList<>(Arrays.asList(0, 1))).withNotNull();
    ...
    void reduceToRelatedFieldSpec_whenSomeValid_returnReducedWhiteList() {
        ...
        FieldSpec expected = FieldSpecFactory.fromList(new UniformList<>(Collections.singletonList(0))).withNotNull();
        FieldSpec actual = testInstance.createModifierFromOtherFieldSpec(parameter);
