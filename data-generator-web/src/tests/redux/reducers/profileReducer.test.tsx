...
describe('Profile reducer', () => {
    it('Should handle undefined state', () => {
        ...
        Reducer(profileReducer).withState(undefined).expect(mockAction).toReturnState(StateHelper.EmptyState);
    });
    it('Should handle CLEAR_CURRENT_PROFILE action', () => {
        ...
        Reducer(profileReducer).withState(StateHelper.GenericFieldState).expect(cleanProfile).toReturnState(StateHelper.EmptyState);
    });
