...
/*
 * This analyser generates a basic regex constraint that is based on the detected string length
 * of the username and domain-name components of email addresses in the data
 */
class EmailAnalyserRegexFromData(val df: DataFrame, val field: StructField) extends EmailAnalyser {
