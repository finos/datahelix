...
Each directory describes a single test and the name of that directory will also appear in the test runner. Each directory should have a profile.json file, an expected.json file and a README file to explain the purpose of the test.
