...
public class DataBagRowGenerator implements RowGenerator {
    private final GenerationConfig generationConfig;
    private final RowSpecDataBagSourceFactory dataBagSourceFactory;

    @Inject
    public DataBagRowGenerator(GenerationConfig generationConfig, RowSpecDataBagSourceFactory dataBagSourceFactory){
