...
public class StringConstraintValidationMessages  implements StandardValidationMessages {
    ...
    public StringConstraintValidationMessages(int validMinLength, int validMaxLength, int invalidMinLength, int invalidMaxLength) {
    ...
    public String getVerboseMessage() {
        return String.format("String length constraint between %s and %s is not valid. The valid range is between %s and %s.", invalidMinLength, invalidMaxLength, validMinLength, validMaxLength);
    }
}
