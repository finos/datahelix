...
public class EqualToOffsetDateRelation implements FieldSpecRelations {
    ...
    public FieldSpec reduceToRelatedFieldSpec(FieldSpec otherValue) {
        if (otherValue.getDateTimeRestrictions() != null) {
            Limit<OffsetDateTime> limit = otherValue.getDateTimeRestrictions().getMin();
            ...
            LinearRestrictions<OffsetDateTime> newRestrictions = LinearRestrictionsFactory.createDateTimeRestrictions(newLimit, newLimit);
