...
public class IsAThingToDeleteConstraint implements AtomicConstraint, VisitableProfileElement {
    public final Field field;
    private final Set<RuleInformation> rules;
    public final ParsedGranularity granularity;

    public IsAThingToDeleteConstraint(Field field, ParsedGranularity granularity, Set<RuleInformation> rules) {
    ...
    public boolean equals(Object o){
        ...
        IsAThingToDeleteConstraint constraint = (IsAThingToDeleteConstraint) o;
    ...
    public AtomicConstraint withRules(Set<RuleInformation> rules) {
        return new IsAThingToDeleteConstraint(this.field, this.granularity, rules);
    }
