...
public class AfterDateRelationTest {
    ...
    private final Field a = Field.create("a", SpecificFieldType.DATETIME, false, "", false, false);
    private final Field b = Field.create("b", SpecificFieldType.DATETIME, false, "", false, false);
