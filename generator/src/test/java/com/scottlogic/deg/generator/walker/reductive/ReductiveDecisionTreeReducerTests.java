...
//    private static final ConstraintReducer constraintReducer = new ConstraintReducer(fieldSpecFactory, fieldSpecMerger);
//
//    @Test
//    public void shouldNoOpReduceEmptyTree(){
//        ConstraintNode tree = TreeConstraintNode.empty;
//        ReductiveTreePruner reducer = new ReductiveTreePruner(
//            fieldSpecMerger,
//            constraintReducer);
//
//        TreeConstraintNode reduced = reducer.reduce(tree, initialState);
//
...
//
//        TreeConstraintNode reduced = reducer.reduce(tree, field2Fixed);
//
...
//
//        TreeConstraintNode reduced = reducer.reduce(tree, field1Fixed);
//
//        Assert.assertThat(reduced.getAtomicConstraints(), containsInAnyOrder(isEqualTo1));
//        Assert.assertThat(reduced.getDecisions().size(), equalTo(1));
//        Assert.assertThat(
...
//
//        TreeConstraintNode reduced = reducer.reduce(tree, fields2And3Fixed);
//
//        Assert.assertThat(
//            reduced,
//            equalTo(null));
...
//
//        TreeConstraintNode reduced = reducer.reduce(tree, field3Fixed);
//
