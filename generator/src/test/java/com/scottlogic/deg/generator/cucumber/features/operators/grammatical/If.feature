...
Scenario: Running an 'if' request that contains a valid nested if statement should be successful
       ...
       """
         ...
         "then": { "if": { "field": "foo", "is": "greaterThan", "value": 3 },
         "then": { "field": "bar", "is": "equalTo", "value": "a" },
         "else": { "field": "bar", "is": "equalTo", "value": "b" } },
...
Scenario: Running an if request that contains a non contradictory ofType constraint within its then statement should be successful
       ...
       """
         {
         "if": { "field": "foo", "is": "equalTo", "value": "a" },
         "then": { "field": "bar", "is": "ofType", "value": "string" },
         "else": { "field": "bar", "is": "equalTo", "value": 10 }
         }
       """
     Then the following data should be generated:
...
Scenario: Running an if request that contains a non contradictory after constraint within its if statement should be successful
       ...
       """
         {
         "if": { "field": "foo", "is": "after", "value": { "date": "2018-01-02T00:00:00.000" } },
         "then": { "field": "bar", "is": "equalTo", "value": { "date": "2010-01-01T00:00:00.000" } },
         "else": { "field": "bar", "is": "equalTo", "value": { "date": "2010-01-05T00:00:00.000" } }
         }
       """
     Then the following data should be generated:
       | foo                     | bar                     |
       | 2018-01-01T00:00:00.000 | 2010-01-05T00:00:00.000 |
       | 2018-02-01T00:00:00.000 | 2010-01-01T00:00:00.000 |
       | 2018-03-01T00:00:00.000 | 2010-01-01T00:00:00.000 |
       | 2018-04-01T00:00:00.000 | 2010-01-01T00:00:00.000 |
       | 2018-05-01T00:00:00.000 | 2010-01-01T00:00:00.000 |
...
Scenario: Running an if request that contains a non contradictory after constraint within its then statement should be successful
       ...
       """
         {
         "if": { "field": "foo", "is": "equalTo", "value": { "date": "2018-02-01T00:00:00.000" } },
         "then": { "field": "bar", "is": "after", "value": { "date": "2010-01-04T00:00:00.000" } },
         "else": { "field": "bar", "is": "equalTo", "value": { "date": "2010-01-01T00:00:00.000" } }
         }
       """
     Then the following data should be generated:
       | foo                     | bar                     |
       | 2018-01-01T00:00:00.000 | 2010-01-01T00:00:00.000 |
       | 2018-02-01T00:00:00.000 | 2010-01-05T00:00:00.000 |
       | 2018-03-01T00:00:00.000 | 2010-01-01T00:00:00.000 |
       | 2018-04-01T00:00:00.000 | 2010-01-01T00:00:00.000 |
       | 2018-05-01T00:00:00.000 | 2010-01-01T00:00:00.000 |
       | 2018-06-01T00:00:00.000 | 2010-01-01T00:00:00.000 |
...
Scenario: Running an if request that contains a non contradictory after constraint within its else statement should be successful
       ...
       """
         {
         "if": { "field": "foo", "is": "equalTo", "value": { "date": "2018-01-01T00:00:00.000" } },
         "then": { "field": "bar", "is": "equalTo", "value": { "date": "2010-01-01T00:00:00.000" } },
         "else": { "field": "bar", "is": "after", "value": { "date": "2010-01-04T00:00:00.000" } }
         }
       """
     Then the following data should be generated:
       | foo                     | bar                     |
       | 2018-01-01T00:00:00.000 | 2010-01-01T00:00:00.000 |
       | 2018-02-01T00:00:00.000 | 2010-01-05T00:00:00.000 |
       | 2018-03-01T00:00:00.000 | 2010-01-05T00:00:00.000 |
       | 2018-04-01T00:00:00.000 | 2010-01-05T00:00:00.000 |
       | 2018-05-01T00:00:00.000 | 2010-01-05T00:00:00.000 |
...
Scenario: Running an if request that contains a contradictory after constraint within its if statement should be successful
       ...
       """
         {
         "if": { "field": "foo", "is": "after", "value": { "date": "2020-01-01T00:00:00.000" } },
         "then": { "field": "bar", "is": "equalTo", "value": { "date": "2010-01-01T00:00:00.000" } },
         "else": { "field": "bar", "is": "equalTo", "value": { "date": "2010-01-04T00:00:00.000" } }
         }
       """
    Then the following data should be generated:
      | foo                     | bar                     |
      | 2018-01-01T00:00:00.000 | 2010-01-04T00:00:00.000 |
      | 2018-02-01T00:00:00.000 | 2010-01-04T00:00:00.000 |
      | 2018-03-01T00:00:00.000 | 2010-01-04T00:00:00.000 |
      | 2018-04-01T00:00:00.000 | 2010-01-04T00:00:00.000 |
      | 2018-05-01T00:00:00.000 | 2010-01-04T00:00:00.000 |
...
Scenario: Running an if request that contains a contradictory after constraint within its then statement should be successful
       ...
       """
         {
         "if": { "field": "foo", "is": "equalTo", "value": { "date": "2018-01-01T00:00:00.000" } },
         "then": { "field": "bar", "is": "after", "value": { "date": "2020-01-01T00:00:00.000" } },
         "else": { "field": "bar", "is": "equalTo", "value": { "date": "2010-01-04T00:00:00.000" } }
         }
       """
     Then the following data should be generated:
...
Scenario: Running an if request that contains a contradictory after constraint within its else statement should be successful
       ...
       """
         ...
         "if": { "field": "foo", "is": "equalTo", "value": { "date": "2018-01-01T00:00:00.000" } },
         "then": { "field": "bar", "is": "equalTo", "value": { "date": "2010-01-01T00:00:00.000" } },
         "else": { "field": "bar", "is": "after", "value": { "date": "2020-01-01T00:00:00.000" } }
         }
       """
     Then the following data should be generated:
       | foo                     | bar                     |
...
Scenario: Running an if request that contains a non contradictory afterOrAt constraint within its if statement should be successful
       ...
       """
         {
         "if": { "field": "foo", "is": "afterOrAt", "value": { "date": "2018-05-01T00:00:00.000" } },
         "then": { "field": "bar", "is": "equalTo", "value": { "date": "2010-01-05T00:00:00.000" } },
         "else": { "field": "bar", "is": "equalTo", "value": { "date": "2010-01-01T00:00:00.000" } }
         }
       """
     Then the following data should be generated:
...
Scenario: Running an if request that contains a non contradictory afterOrAt constraint within its then statement should be successful
       ...
       """
         {
         "if": { "field": "foo", "is": "equalTo", "value": { "date": "2018-05-01T00:00:00.000" } },
         "then": { "field": "bar", "is": "afterOrAt", "value": { "date": "2010-01-04T00:00:00.000" } },
         "else": { "field": "bar", "is": "equalTo", "value": { "date": "2010-01-01T00:00:00.000" } }
         }
       """
     Then the following data should be generated:
...
Scenario: Running an if request that contains a non contradictory afterOrAt constraint within its else statement should be successful
       ...
       """
         {
         "if": { "field": "foo", "is": "equalTo", "value": { "date": "2018-06-01T00:00:00.000" } },
         "then": { "field": "bar", "is": "equalTo", "value": { "date": "2010-01-01T00:00:00.000" } },
         "else": { "field": "bar", "is": "afterOrAt", "value": { "date": "2010-01-04T00:00:00.000" } }
         }
       """
     Then the following data should be generated:
       | foo                     | bar                     |
...
Scenario: Running an if request that contains a contradictory afterOrAt constraint within its if statement should be successful
    ...
    And there is a constraint:
       """
         {
         "if": { "field": "foo", "is": "afterOrAt", "value": { "date": "2020-01-01T00:00:00.000" } },
         "then": { "field": "bar", "is": "equalTo", "value": { "date": "2010-01-01T00:00:00.000" } },
         "else": { "field": "bar", "is": "equalTo", "value": { "date": "2010-01-05T00:00:00.000" } }
         }
       """
...
Scenario: Running an if request that contains a contradictory afterOrAt constraint within its then statement should be successful
       ...
       """
         {
         "if": { "field": "foo", "is": "equalTo", "value": { "date": "2018-01-01T00:00:00.000" } },
         "then": { "field": "bar", "is": "afterOrAt", "value": { "date": "2020-01-01T00:00:00.000" } },
         "else": { "field": "bar", "is": "equalTo", "value": { "date": "2010-01-05T00:00:00.000" } }
         }
       """
     Then the following data should be generated:
...
Scenario: Running an if request that contains a contradictory afterOrAt constraint within its else statement should be successful
       ...
       """
         ...
         "if": { "field": "foo", "is": "equalTo", "value": { "date": "2018-01-01T00:00:00.000" } },
         "then": { "field": "bar", "is": "equalTo", "value": { "date": "2010-01-01T00:00:00.000" } },
         "else": { "field": "bar", "is": "afterOrAt", "value": { "date": "2020-01-05T00:00:00.000" } }
         }
       """
     Then the following data should be generated:
       | foo                     | bar                     |
...
Scenario: Running an if request that contains a non contradictory before constraint within its if statement should be successful
       ...
       """
         {
         "if": { "field": "foo", "is": "before", "value": { "date": "2018-02-01T00:00:00.000" } },
         "then": { "field": "bar", "is": "equalTo", "value": { "date": "2010-01-01T00:00:00.000" } },
         "else": { "field": "bar", "is": "equalTo", "value": { "date": "2010-01-05T00:00:00.000" } }
         }
       """
...
Scenario: Running an if request that contains a non contradictory before constraint within its then statement should be successful
       ...
       """
         {
         "if": { "field": "foo", "is": "equalTo", "value": { "date": "2018-01-01T00:00:00.000" } },
         "then": { "field": "bar", "is": "before", "value": { "date": "2010-01-03T00:00:00.000" } },
         "else": { "field": "bar", "is": "equalTo", "value": { "date": "2010-01-05T00:00:00.000" } }
         }
       """
     Then the following data should be generated:
       | foo                     | bar                     |
       | 2018-01-01T00:00:00.000 | 2010-01-01T00:00:00.000 |
       | 2018-01-01T00:00:00.000 | 2010-01-02T00:00:00.000 |
       | 2018-02-01T00:00:00.000 | 2010-01-05T00:00:00.000 |
       | 2018-03-01T00:00:00.000 | 2010-01-05T00:00:00.000 |
       | 2018-04-01T00:00:00.000 | 2010-01-05T00:00:00.000 |
       | 2018-05-01T00:00:00.000 | 2010-01-05T00:00:00.000 |
...
Scenario: Running an if request that contains a non contradictory before constraint within its else statement should be successful
       ...
       """
         ...
         "if": { "field": "foo", "is": "equalTo", "value": { "date": "2018-01-01T00:00:00.000" } },
         "then": { "field": "bar", "is": "equalTo", "value": { "date": "2010-01-05T00:00:00.000" } },
         "else": { "field": "bar", "is": "before", "value": { "date": "2010-01-03T00:00:00.000" } }
         }
       """
     Then the following data should be generated:
       | foo                     | bar                     |
       | 2018-01-01T00:00:00.000 | 2010-01-05T00:00:00.000 |
       | 2018-02-01T00:00:00.000 | 2010-01-01T00:00:00.000 |
       | 2018-02-01T00:00:00.000 | 2010-01-02T00:00:00.000 |
       | 2018-03-01T00:00:00.000 | 2010-01-01T00:00:00.000 |
       | 2018-03-01T00:00:00.000 | 2010-01-02T00:00:00.000 |
       | 2018-04-01T00:00:00.000 | 2010-01-01T00:00:00.000 |
       | 2018-04-01T00:00:00.000 | 2010-01-02T00:00:00.000 |
       | 2018-05-01T00:00:00.000 | 2010-01-01T00:00:00.000 |
       | 2018-05-01T00:00:00.000 | 2010-01-02T00:00:00.000 |
       | 2018-06-01T00:00:00.000 | 2010-01-01T00:00:00.000 |
...
Scenario: Running an if request that contains a contradictory before constraint within its if statement should be successful
       ...
       """
         {
         "if": { "field": "foo", "is": "before", "value": { "date": "2010-01-01T00:00:00.000" } },
         "then": { "field": "bar", "is": "equalTo", "value": { "date": "2010-01-05T00:00:00.000" } },
         "else": { "field": "bar", "is": "equalTo", "value": { "date": "2010-01-03T00:00:00.000" } }
         }
       """
     Then the following data should be generated:
       | foo                     | bar                     |
       | 2018-01-01T00:00:00.000 | 2010-01-03T00:00:00.000 |
       | 2018-02-01T00:00:00.000 | 2010-01-03T00:00:00.000 |
       | 2018-03-01T00:00:00.000 | 2010-01-03T00:00:00.000 |
       | 2018-04-01T00:00:00.000 | 2010-01-03T00:00:00.000 |
       | 2018-05-01T00:00:00.000 | 2010-01-03T00:00:00.000 |
...
Scenario: Running an if request that contains a contradictory before constraint within its then statement should be successful
       ...
       """
         {
         "if": { "field": "foo", "is": "equalTo", "value": { "date": "2018-01-01T00:00:00.000" } },
         "then": { "field": "bar", "is": "before", "value": { "date": "2010-01-01T00:00:00.000" } },
         "else": { "field": "bar", "is": "equalTo", "value": { "date": "2010-01-03T00:00:00.000" } }
         }
       """
     Then the following data should be generated:
...
Scenario: Running an if request that contains a contradictory before constraint within its else statement should be successful
       ...
       """
         ...
         "if": { "field": "foo", "is": "equalTo", "value": { "date": "2018-01-01T00:00:00.000" } },
         "then": { "field": "bar", "is": "equalTo", "value": { "date": "2010-01-01T00:00:00.000" } },
         "else": { "field": "bar", "is": "before", "value": { "date": "2010-01-01T00:00:00.000" } }
         }
       """
     Then the following data should be generated:
       | foo                     | bar                     |
...
Scenario: Running an if request that contains a non contradictory beforeOrAt constraint within its if statement should be successful
       ...
       """
         {
         "if": { "field": "foo", "is": "beforeOrAt", "value": { "date": "2018-02-01T00:00:00.000" } },
         "then": { "field": "bar", "is": "equalTo", "value": { "date": "2010-01-01T00:00:00.000" } },
         "else": { "field": "bar", "is": "equalTo", "value": { "date": "2010-01-05T00:00:00.000" } }
         }
       """
...
Scenario: Running an if request that contains a non contradictory beforeOrAt constraint within its then statement should be successful
       ...
       """
         {
         "if": { "field": "foo", "is": "equalTo", "value": { "date": "2018-01-01T00:00:00.000" } },
         "then": { "field": "bar", "is": "beforeOrAt", "value": { "date": "2010-01-03T00:00:00.000" } },
         "else": { "field": "bar", "is": "equalTo", "value": { "date": "2010-01-05T00:00:00.000" } }
         }
       """
     Then the following data should be generated:
...
Scenario: Running an if request that contains a non contradictory beforeOrAt constraint within its else statement should be successful
       ...
       """
         ...
         "if": { "field": "foo", "is": "equalTo", "value": { "date": "2018-01-01T00:00:00.000" } },
         "then": { "field": "bar", "is": "equalTo", "value": { "date": "2010-01-05T00:00:00.000" } },
         "else": { "field": "bar", "is": "beforeOrAt", "value": { "date": "2010-01-03T00:00:00.000" } }
         }
       """
     Then the following data should be generated:
       | foo                     | bar                     |
...
Scenario: Running an if request that contains a contradictory beforeOrAt constraint within its if statement should be successful
       ...
       """
         {
         "if": { "field": "foo", "is": "beforeOrAt", "value": { "date": "2009-01-01T00:00:00.000" } },
         "then": { "field": "bar", "is": "equalTo", "value": { "date": "2010-01-05T00:00:00.000" } },
         "else": { "field": "bar", "is": "equalTo", "value": { "date": "2010-01-03T00:00:00.000" } }
         }
       """
...
Scenario: Running an if request that contains a contradictory beforeOrAt constraint within its then statement should be successful
       ...
       """
         {
         "if": { "field": "foo", "is": "equalTo", "value": { "date": "2018-01-01T00:00:00.000" } },
         "then": { "field": "bar", "is": "beforeOrAt", "value": { "date": "2009-01-01T00:00:00.000" } },
         "else": { "field": "bar", "is": "equalTo", "value": { "date": "2010-01-03T00:00:00.000" } }
         }
       """
     Then the following data should be generated:
...
Scenario: Running an if request that contains a contradictory beforeOrAt constraint within its else statement should be successful
       ...
       """
         ...
         "if": { "field": "foo", "is": "equalTo", "value": { "date": "2018-01-01T00:00:00.000" } },
         "then": { "field": "bar", "is": "equalTo", "value": { "date": "2010-01-01T00:00:00.000" } },
         "else": { "field": "bar", "is": "beforeOrAt", "value": { "date": "2009-01-01T00:00:00.000" } }
         }
       """
     Then the following data should be generated:
       | foo                     | bar                     |
